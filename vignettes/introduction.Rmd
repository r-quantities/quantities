...
We have found that defining quantities columns as lists (where each element consists of one value, one unit and one error) may be a workaround, but this probably would be a serious performance penalty for a package that is typically chosen for speed reasons.
